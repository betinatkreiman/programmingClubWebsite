...
boxOne.onmouseover = function() {
  ...
  TweenMax.to("p1", 1, { fontSize: 18.05, ease: Sine.easeOut, autoRound: false});
...
boxTwo.onmouseover = function() {
  ...
  TweenMax.to("p2", 1, { fontSize: 18.05, ease: Sine.easeOut, autoRound: false});
...
boxThree.onmouseover = function() {
  ...
  TweenMax.to("p3", 1, { fontSize: 18.05, ease: Sine.easeOut, autoRound: false});
